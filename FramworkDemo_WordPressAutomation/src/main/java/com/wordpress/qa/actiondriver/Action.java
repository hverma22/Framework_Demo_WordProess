		...
		public static boolean findElement(WebDriver ldriver,WebElement locatorName) throws Throwable{
				...
				try{
					...
					if (flag) {
						...
						//SuccessReport("FindElement", "Successfully Found element at: \""+locatorName+"\"");
						//return true;
					} else {
			...
			public static boolean JSClick(WebElement locator)
					throws Throwable {
				boolean flag = false;
				try {
			...
			public boolean mouseover(WebElement locator, String locatorName)
					throws Throwable {
				boolean flag = false;
				try {
					WebElement mo = locator;
